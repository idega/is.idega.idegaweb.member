...
public interface GroupApplicationHome extends com.idega.data.IDOHome
{
 ...
 public java.util.Collection findAllApplicationsByStatusAndUserOrderedByCreationDate(java.lang.String p0,com.idega.user.data.User p1)throws javax.ejb.FinderException,java.rmi.RemoteException, java.rmi.RemoteException;
