...
public void addGroups(List groups) throws IDOAddRelationshipException {
  ...
  public Collection ejbFindAllApplicationsByStatusAndUserAndApplicationGroupOrderedByCreationDate(String status, User user, Group applicationGroup) throws FinderException,RemoteException{
	StringBuffer sql = new StringBuffer();
   	sql.append("select * from ").append(getEntityName()).append(" where ").append(COLUMN_STATUS)
   	.append("='").append(status)
   	.append("' and ").append(COLUMN_USER_ID).append("=").append( ((Integer)user.getPrimaryKey()).intValue() )
  ...
  public Collection ejbFindAllApplicationsByUserAndApplicationGroupOrderedByCreationDate(User user, Group applicationGroup) throws FinderException,RemoteException{
	StringBuffer sql = new StringBuffer();
