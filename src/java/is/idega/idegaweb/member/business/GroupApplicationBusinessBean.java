...
public class GroupApplicationBusinessBean extends IBOServiceBean implements GroupApplicationBusiness, UserGroupPlugInBusiness{
	...
	public Collection getGroupApplicationsByStatusAndUserAndApplicationGroupOrderedByCreationDate(String status, User user, Group applicationGroup) {
		...
		try {
			GroupApplicationHome grHome = getGroupApplicationHome();
			apps =  grHome.findFindAllApplicationsByStatusAndUserAndApplicationGroupOrderedByCreationDate(status, user, applicationGroup);
		} catch (RemoteException e) {
			e.printStackTrace();
		} catch (FinderException e) {
			e.printStackTrace();
	...
	@Override
	public Collection getGroupApplicationsByUserAndApplicationGroupOrderedByCreationDate(User user, Group applicationGroup) {
		Collection apps = null;
		try {
			GroupApplicationHome grHome = getGroupApplicationHome();
			apps =  grHome.findFindAllApplicationsByUserAndApplicationGroupOrderedByCreationDate(user, applicationGroup);
		} catch (RemoteException e) {
			e.printStackTrace();
		} catch (FinderException e) {
			e.printStackTrace();
	...
	/**
	 * @see com.idega.user.business.UserGroupPlugInBusiness#afterGroupCreateOrUpdate(Group, Group)
	 */
	@Override
	...
	/**
	 * @see com.idega.user.business.UserGroupPlugInBusiness#afterUserCreateOrUpdate(User, Group)
	 */
	@Override
	...
	/**
	 * @see com.idega.user.business.UserGroupPlugInBusiness#beforeGroupRemove(Group, Group)
	 */
	@Override
	...
	/**
	 * @see com.idega.user.business.UserGroupPlugInBusiness#beforeUserRemove(User, Group)
	 */
	@Override
