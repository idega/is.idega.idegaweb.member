...
public class KRImportFileHandlerBean extends IBOServiceBean implements KRImportFileHandler {
	...
	public boolean handleRecords() throws RemoteException {
		...
		try {
			...
			/*
			 * try { transaction.rollback(); } catch (SystemException e) { e.printStackTrace(); }
			 */
	...
	protected boolean storeUserInfo() throws RemoteException {
		...
		try {
			// email
			// both this and phones is very much a stupid hack in my part. I should have used findMethods etc. or make a useful
			// getOrCreateIfNonExisting...bleh! -Eiki
			if (email != null) {
		...
		/*
		 * Need to add a cashier which should be the admin of the club. and a categoryid com.idega.block.finance.business.AccountManager public static
		 * Account makeNewFinanceAccount(int iUserId, String sName,String sExtra, int iCashierId,int iCategoryId)throws Exception{
		 */
