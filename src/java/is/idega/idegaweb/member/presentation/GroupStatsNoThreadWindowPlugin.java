...
public class GroupStatsNoThreadWindowPlugin implements ToolbarElement {
	...
	public String getName(IWContext iwc) {
		...
		return resourceBundle.getLocalizedString("button.group_no_thread_report_tool", "Group Report Tool");
	}
	...
	public Class getPresentationObjectClass(IWContext iwc) {
		return GroupStatsNoThreadWindow.class;
	}
