	...
	public boolean store(IWContext iwc) {
		...
		try {
			...
			if (usingNetbokhald != null) {
				group.setMetaData(IWMemberConstants.META_DATA_CLUB_USING_NETBOKHALD,usingNetbokhald.toString());
			} else {
				group.setMetaData(IWMemberConstants.META_DATA_CLUB_USING_NETBOKHALD,Boolean.FALSE.toString());
			}
	...
	public void initFieldContents() {
		...
		try {
			...
			String netbokhald = group
					.getMetaData(IWMemberConstants.META_DATA_CLUB_USING_NETBOKHALD);
			if (number != null) {
				this.fieldValues.put(this.numberFieldName, number);
			}
			if (ssn != null) {
