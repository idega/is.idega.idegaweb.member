...
public class UserStatsNoThreadWindowPlugin implements ToolbarElement {
	...
	public String getName(IWContext iwc) {
		...
		return resourceBundle.getLocalizedString("button.user_no_thread_report_tool", "User Report Tool");
	}
	...
	public Class getPresentationObjectClass(IWContext iwc) {
		return UserStatsNoThreadWindow.class;
	}
